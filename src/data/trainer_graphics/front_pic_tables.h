const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_LEADER_ROARK] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_GARDENIA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_MAYLENE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_WAKE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_FANTINA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_BYRON] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CANDICE] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_VOLKNER] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CILAN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CHILI] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CRESS] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_LENORA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_BURGH] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_ELESA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CLAY] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_SKYLA] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_BRYCEN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_DRAYDEN] = {.size = 8, .y_offset = 1},
    [TRAINER_PIC_LEADER_CHEREN] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_BROCK, gTrainerFrontPic_Brock, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MISTY, gTrainerFrontPic_Misty, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_SURGE, gTrainerFrontPic_Surge, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ERIKA, gTrainerFrontPic_Erika, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_JANINE, gTrainerFrontPic_Janine, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_SABRINA, gTrainerFrontPic_Sabrina, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BLAINE, gTrainerFrontPic_Blaine, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_GIOVANNI, gTrainerFrontPic_Giovanni, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_FALKNER, gTrainerFrontPic_Falkner, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BUGSY, gTrainerFrontPic_Bugsy, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_WHITNEY, gTrainerFrontPic_Whitney, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MORTY, gTrainerFrontPic_Morty, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CHUCK, gTrainerFrontPic_Chuck, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_JASMINE, gTrainerFrontPic_Jasmine, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_PRYCE, gTrainerFrontPic_Pryce, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CLAIR, gTrainerFrontPic_Clair, TRAINER_PIC_SIZE),
    ...
    TRAINER_SPRITE(LEADER_ROARK, gTrainerFrontPic_Roark, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_GARDENIA, gTrainerFrontPic_Gardenia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MAYLENE, gTrainerFrontPic_Maylene, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_WAKE, gTrainerFrontPic_Wake, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_FANTINA, gTrainerFrontPic_Fantina, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BYRON, gTrainerFrontPic_Byron, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CANDICE, gTrainerFrontPic_Candice, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_VOLKNER, gTrainerFrontPic_Volkner, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CILAN, gTrainerFrontPic_Cilan, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CHILI, gTrainerFrontPic_Chili, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CRESS, gTrainerFrontPic_Cress, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_LENORA, gTrainerFrontPic_Lenora, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BURGH, gTrainerFrontPic_Burgh, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ELESA, gTrainerFrontPic_Elesa, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CLAY, gTrainerFrontPic_Clay, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_SKYLA, gTrainerFrontPic_Skyla, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_BRYCEN, gTrainerFrontPic_Brycen, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_DRAYDEN, gTrainerFrontPic_Drayden, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_CHEREN, gTrainerFrontPic_Cheren, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_ROXIE, gTrainerFrontPic_Roxie, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(LEADER_MARLON, gTrainerFrontPic_Marlon, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_BLUE, gTrainerFrontPic_Blue, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_LANCE, gTrainerFrontPic_Lance, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_CYNTHIA, gTrainerFrontPic_Cynthia, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_ALDER, gTrainerFrontPic_Alder, TRAINER_PIC_SIZE),
    TRAINER_SPRITE(CHAMPION_IRIS, gTrainerFrontPic_Iris, TRAINER_PIC_SIZE),
};
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(LEADER_SABRINA, gTrainerPalette_Sabrina),
    TRAINER_PAL(LEADER_BLAINE, gTrainerPalette_Blaine),
    TRAINER_PAL(LEADER_GIOVANNI, gTrainerPalette_Giovanni),
    TRAINER_PAL(LEADER_FALKNER, gTrainerPalette_Falkner),
    TRAINER_PAL(LEADER_BUGSY, gTrainerPalette_Bugsy),
    TRAINER_PAL(LEADER_WHITNEY, gTrainerPalette_Whitney),
    ...
    TRAINER_PAL(LEADER_TATE, gTrainerPalette_Tate),
    TRAINER_PAL(LEADER_LIZA, gTrainerPalette_Liza),
    TRAINER_PAL(LEADER_ROARK, gTrainerPalette_Roark),
    TRAINER_PAL(LEADER_GARDENIA, gTrainerPalette_Gardenia),
    TRAINER_PAL(LEADER_MAYLENE, gTrainerPalette_Maylene),
    TRAINER_PAL(LEADER_WAKE, gTrainerPalette_Wake),
    TRAINER_PAL(LEADER_FANTINA, gTrainerPalette_Fantina),
    TRAINER_PAL(LEADER_BYRON, gTrainerPalette_Byron),
    TRAINER_PAL(LEADER_CANDICE, gTrainerPalette_Candice),
    TRAINER_PAL(LEADER_VOLKNER, gTrainerPalette_Volkner),
    TRAINER_PAL(LEADER_CILAN, gTrainerPalette_Cilan),
    TRAINER_PAL(LEADER_CHILI, gTrainerPalette_Chili),
    TRAINER_PAL(LEADER_CRESS, gTrainerPalette_Cress),
    TRAINER_PAL(LEADER_LENORA, gTrainerPalette_Lenora),
    TRAINER_PAL(LEADER_BURGH, gTrainerPalette_Burgh),
    TRAINER_PAL(LEADER_ELESA, gTrainerPalette_Elesa),
    TRAINER_PAL(LEADER_CLAY, gTrainerPalette_Clay),
    TRAINER_PAL(LEADER_SKYLA, gTrainerPalette_Skyla),
    TRAINER_PAL(LEADER_BRYCEN, gTrainerPalette_Brycen),
    TRAINER_PAL(LEADER_DRAYDEN, gTrainerPalette_Drayden),
    TRAINER_PAL(LEADER_CHEREN, gTrainerPalette_Cheren),
    TRAINER_PAL(LEADER_ROXIE, gTrainerPalette_Roxie),
