...
static const u16 sHiddenGrottoLocationNums[NUM_GROTTO_VARS] =
{
    ...
    MAP_NUM(PETALBURG_WOODS), MAP_NUM(ROUTE120)
};
...
static const u16 sHiddenGrottoLocationGroups[NUM_GROTTO_VARS] =
{
    ...
    MAP_GROUP(PETALBURG_WOODS), MAP_GROUP(ROUTE120)
};
...
static const u16 sRandomSpeciesForEgg[NUM_RANDOM_EGG_SPECIES] =
{
    SPECIES_EKANS, SPECIES_VULPIX, SPECIES_GROWLITHE, SPECIES_DODUO, SPECIES_CLEFFA, SPECIES_IGGLYBUFF, SPECIES_TOGEPI, 
    SPECIES_SENTRET, SPECIES_MAREEP, SPECIES_SNUBBULL, SPECIES_SWINUB, SPECIES_TYROGUE, SPECIES_SMOOCHUM, SPECIES_ELEKID, 
    SPECIES_MAGBY, SPECIES_RALTS, SPECIES_AZURILL, SPECIES_SKITTY, SPECIES_WYNAUT, SPECIES_SHINX, SPECIES_BONSLY, 
    SPECIES_MIME_JR, SPECIES_HAPPINY, SPECIES_MUNCHLAX, SPECIES_RIOLU, SPECIES_MANTYKE, SPECIES_MUNNA, SPECIES_SANDILE, 
    SPECIES_DARUMAKA, SPECIES_ZORUA, SPECIES_GOTHITA, SPECIES_DUCKLETT, SPECIES_LITLEO, SPECIES_PANCHAM, SPECIES_ESPURR, 
    SPECIES_INKAY, SPECIES_NOIBAT, SPECIES_ROCKRUFF, SPECIES_MAREANIE, SPECIES_SALANDIT, SPECIES_STUFFUL, SPECIES_KOMALA, 
    SPECIES_NICKIT, SPECIES_CHEWTLE, SPECIES_CRAMORANT, SPECIES_TOXEL, SPECIES_HATENNA, SPECIES_IMPIDIMP, SPECIES_DREEPY
};

static const u16 sRandomSpeciesForSpecialEgg[NUM_SPECIAL_EGG_SPECIES] =
{
    ...
    SPECIES_GROOKEY, SPECIES_SCORBUNNY, SPECIES_SOBBLE, SPECIES_PHIONE, SPECIES_GROWLITHE_HISUIAN, SPECIES_SNEASEL_HISUIAN, SPECIES_ZORUA_HISUIAN,
    SPECIES_DRATINI, SPECIES_LARVITAR, SPECIES_BAGON, SPECIES_GIBLE, SPECIES_DEINO, SPECIES_NOIBAT, SPECIES_GOOMY,
...
{
    return sRandomSpeciesForEgg[Random() % NUM_RANDOM_EGG_SPECIES];
}

u16 GetSpeciesForSpecialEgg(void)
{
    return sRandomSpeciesForEgg[Random() % NUM_SPECIAL_EGG_SPECIES];
}

void IncrementAdoptionSpecials(void)
{
    VarSet(VAR_DAYCARE_ADOPTION_SPECIALS, (VarGet(VAR_DAYCARE_ADOPTION_SPECIALS) + 1 % 32));
