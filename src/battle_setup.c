...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY, TRAINER_SIDNEY_2 , TRAINER_SIDNEY_3, TRAINER_SIDNEY_4, TRAINER_SIDNEY_5, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE, TRAINER_PHOEBE_2, TRAINER_PHOEBE_3, TRAINER_PHOEBE_4, TRAINER_PHOEBE_5, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA, TRAINER_GLACIA_2, TRAINER_GLACIA_3, TRAINER_GLACIA_4, TRAINER_GLACIA_5, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE, TRAINER_DRAKE_2, TRAINER_DRAKE_3, TRAINER_DRAKE_4, TRAINER_DRAKE_5, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_STEVEN_2, TRAINER_STEVEN_3, TRAINER_STEVEN_4, TRAINER_STEVEN_5, EVER_GRANDE_CITY),
};
