...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, TRAINER_SIDNEY_REMATCH, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, TRAINER_PHOEBE_REMATCH, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, TRAINER_GLACIA_REMATCH, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, TRAINER_DRAKE_REMATCH, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, TRAINER_WALLACE_REMATCH, EVER_GRANDE_CITY),
};
