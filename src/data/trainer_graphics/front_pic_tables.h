const struct MonCoords gTrainerFrontPicCoords[] =
{
    ...
    [TRAINER_PIC_KAHILI] = {.size = 8, .y_offset = 1},
...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(KAHILI, gTrainerFrontPic_Kahili, TRAINER_PIC_SIZE),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(MAGMA_GRUNT_M, gTrainerPalette_MagmaGrunt),
    ...
    TRAINER_PAL(MAGMA_GRUNT_F, gTrainerPalette_MagmaGrunt),
    ...
    TRAINER_PAL(KAHILI, gTrainerPalette_Kahili),
