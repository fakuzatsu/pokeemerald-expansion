...
//#define FREE_TRAINER_HILL             //frees up trainer hill data. 28 bytes                          WARNING THIS HAS BEEN SHOWN TO BREAK MULTI BATTLES + BATTLE FRONTIER
...
struct SaveBlock1
{
    ...
    /*0x3???*/ u8 dexNavChain;
    /*0x3???*/ u8 resortRoomDecorations[DECOR_MAX_PLAYERS_HOUSE];
    /*0x3???*/ u8 resortRoomDecorationPositions[DECOR_MAX_PLAYERS_HOUSE];
};
