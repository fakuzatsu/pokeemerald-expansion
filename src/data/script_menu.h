...
static const struct MenuAction MultichoiceList_BrineyOffDewfordNewMoon[] =
{
    {gText_Dewford},
    {gText_NewMoonIsland},
    {gText_Exit},
...
static const struct MenuAction MultichoiceList_SwordOrShield[] =
{
    {gText_Sword},
    {gText_Shield},
    {gText_Exit},
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_BRINEY_OFF_DEWFORD_NEWMOON] = MULTICHOICE(MultichoiceList_BrineyOffDewfordNewMoon),
    ...
    [MULTI_HYPER_TRAINING]             = MULTICHOICE(MultichoiceList_Exit),
