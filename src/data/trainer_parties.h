...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_DEFENSE_CURL, MOVE_SHOCK_WAVE, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 15,
...
static const struct TrainerMon sParty_Nelson[] = {
    #ifdef CANON_MODE
    {
    .lvl = 10,
    .species = SPECIES_WURMPLE,
...
static const struct TrainerMon sParty_KahiliAlt[] = {
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 26,
    .species = SPECIES_RUFFLET,
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STEALTH_ROCK, MOVE_HEAVY_SLAM, MOVE_WILD_CHARGE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
