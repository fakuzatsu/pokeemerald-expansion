...
static const u8 sMemoOldNatureTextColor[] = _("{COLOR BLUE}{SHADOW DARK_GRAY}");
static const u8 sMemoHiddenNatureTextColor[] = _(" ({COLOR LIGHT_RED}{SHADOW GREEN}");
...
static void BufferMonTrainerMemo(void)
{
    ...
    if (sum->hiddenNature != HIDDEN_NATURE_NONE)
    {   
        DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, sMemoOldNatureTextColor);
        DynamicPlaceholderTextUtil_SetPlaceholderPtr(1, sMemoMiscTextColor);
        BufferNatureString();
