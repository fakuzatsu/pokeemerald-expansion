static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(DEWFORD_TOWN), MAP_NUM(DEWFORD_TOWN), 1, 9},
    ...
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(PACIFIDLOG_TOWN), MAP_NUM(PACIFIDLOG_TOWN), 8, 12},
    ...
    [HEAL_LOCATION_PACIFIDLOG_PLAYER_RESORT - 1] = {MAP_GROUP(PACIFIDLOG_TOWN_RESORT), MAP_NUM(PACIFIDLOG_TOWN_RESORT), 17, 4},
};
