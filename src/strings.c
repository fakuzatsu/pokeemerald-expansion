...
const u8 gText_WishingPiece[] = _("Wishing Piece");
const u8 gText_AbilityShield[] = _("Ability Shield");
const u8 gText_ClearAmulet[] = _("Clear Amulet");
const u8 gText_AuspiciousArmor[] = _("Auspicious Armor");
const u8 gText_MaliciousArmor[] = _("Malicious Armor");
const u8 gText_RustedShield[] = _("Rusted Shield");
const u8 gText_RustedSword[] = _("Rusted Sword");
